...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 px-10 py-5 ${
    scrolled ? 'bg-black/90 backdrop-blur-sm shadow-lg ' : 'bg-transparent'}`}>
        ...
        <nav className="flex flex-col gap-4 mt-4">
            <a href="#" className="text-gray-300 hover:text-yellow-400">Home</a>
            <a href="#about" className="text-gray-300 hover:text-yellow-400">About Us</a>
